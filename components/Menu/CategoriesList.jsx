...
import { columnsCategories } from './_dataTable'
...
function CategoriesList() {
  return (
    <MenuTabsContainer
      title={'Categories'}
      description={
        'Naviguez vos differentes sections, selectionner ou modifier les details d une section'
      }
    >
      <CategoriesTable />
    </MenuTabsContainer>
...
function CategoriesTable() {
  ...
  return (
    <div className="">
      <CreateCategoryDrawer open={openDrawer} setOpen={setOpenDrawer} />
            ...
            <div className="overflow-hidden ring-1 ring-black ring-opacity-5 md:rounded-sm">
              <table className="min-w-full text-left divide-y divide-gray-300 table-auto">
                <thead className="bg-gray-50">
                  <tr>
                    {columnsCategories.map((column, index) => (
                      <th
                        key={index}
                        scope="col"
