...
function MenusList() {
  return (
    <MenuTabsContainer
      title={'Menu'}
      description={
        'Naviguez vos differents menu, selectionner ou modifier les details du menu'
      }
    >
      <MenuTable />
    </MenuTabsContainer>
...
function MenuTable() {
  ...
  return (
    <div className="">
      <CreateMenuDrawer open={openDrawer} setOpen={setOpenDrawer} />
                  ...
                  {menus?.map((row, index) => (
                    <tr key={index}>
                      ...
                      <td className="relative flex py-4 pl-3 pr-4 space-x-2 text-sm font-medium text-right whitespace-nowrap sm:pr-6">
                        ...
                        >
                          <RiEdit2Line className="w-4 h-4" aria-hidden="true" />
                        </button>
                        <button
                          type="button"
