...
import { addCommercial, editCommercial } from '../../lib/services/marketing'
import DrawerForm from '../DrawerForm'
import Loader from '../Loader'
import Toggle from '../Toggle'
import { autoFillCommercialForm } from '../../utils/functionFactory'

function CommercialFormDrawer({ commercial, open, setOpen }) {
  ...
  return (
    <>
      <DrawerForm
        ...
        description={
          "Creation d'un commercial de presentation ou de promotion."
        }
        footerButtons={
          <>
            {loading ? (
...
export default CommercialFormDrawer
